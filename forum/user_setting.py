...
def action_account():
    # image_file=url_for('static',filename='profile/' + current_user.image_file)  # this is current user image
    # storing in db image_file = url_for('static', filename='profile/default.jpeg')
